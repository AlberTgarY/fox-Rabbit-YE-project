...
public class Simulator
{
    ...
    public Simulator(int depth, int width)
    {
        ...
        currentWeather = weather.choose_Weather(0);
    ...
    public void simulateOneStep()
    {
        ...
        // Let all rabbits act.
        if(step%2==1&&currentWeather.equals("Sunny"))
        {
        ...
        else if(step%2==0&&currentWeather.equals("Sunny"))
        {
            for(Iterator<Animal> it = animals.iterator(); it.hasNext(); ) {
                Animal animal = it.next();
        ...
        else if(step%2==1&&currentWeather.equals("Rainy"))
        {
            for(Iterator<Animal> it = animals.iterator(); it.hasNext(); ) {
                Animal animal = it.next();
                animal.act(newAnimals);
